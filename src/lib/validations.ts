...
const orderItemSchema = z.object({
  ...
  notes: optionalStringSchema(0, 500).optional(),
});

export const orderStatusEnum = z.enum([
  'pending', 'accepted', 'preparing', 'ready', 'delivering', 'completed', 'cancelled'
]);

export const platformEnum = z.enum(['lineman', 'grab', 'foodpanda', 'walkin']);
