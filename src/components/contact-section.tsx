    ...
    <section id="contact" className="py-24 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          ...
          >
            <Card className="border-border/50 shadow-lg backdrop-blur-sm bg-card/80 h-full">
              <CardContent className="p-8 space-y-8 flex flex-col h-full justify-between">
                ...
                <div className="pt-6 border-t mt-6">
                  <Button className="w-full bg-[#00B900] hover:bg-[#009900] text-white h-14 text-lg font-medium shadow-md transition-all hover:shadow-lg hover:-translate-y-0.5 hover:scale-[1.02] active:scale-95">
          ...
          <motion.div
            ...
            className="h-full min-h-[450px] w-full bg-muted rounded-2xl overflow-hidden shadow-lg border border-border/50 relative"
          >
